<template>
    ...
    <div class="flex flex-col gap-4 mt-4">
        ...
        <p v-if="increment > 15" class="flex gap-2 text-primary text-4xl my-8">
            Seul paramètre important :
            <span :class="`flex flex-row gap-2 ${(increment % 2 === 0) ? 'invisible' : 'visible'}`">Magie ! <UIcon name="i-lucide-wand-sparkles" /></span>
        </p>
        <p v-if="increment > 20">
